...
**External rules** apply to anything you send onward, and they are stricter. No em dashes, ever, along with the en dash and the ellipsis character, which are the same paste-tell and survive more edit passes because they look like ordinary punctuation. Beyond punctuation, the external half splits by register: correspondence should read like a person wrote it, with contractions and varied sentence length, while records like filings and formal denial responses stay plain and precise. Both get the over-explanation cuts, which is the part worth reading if you only read one section.

There is a final-pass checklist at the end, including a grep for the three paste characters that you can actually run.
